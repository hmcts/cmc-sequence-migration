...
DROP_REFERENCE_SQL="DROP SEQUENCE IF EXISTS claim_reference_number_seq"
DROP_LEGAL_REFERENCE_SQL="DROP SEQUENCE IF EXISTS claim_legal_rep_reference_number_seq"
...
DROP_FUNCTION_SQL="DROP FUNCTION IF EXISTS next_reference_number()"
DROP_LEGAL_FUNCTION_SQL="DROP FUNCTION IF EXISTS next_legal_rep_reference_number()"
